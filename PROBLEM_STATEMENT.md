# CDF AI Engineering Hackathon - Problem Statement
...
- EIA Open Data API - electricity prices, generation, capacity by state
...
**Data sources (suggested):**
- NREL Solar Resource Data - PVWatts API for solar potential by location
- EIA State Energy Data - electricity data by state
- EPA FLIGHT - emissions by facility (for offset analysis context)
...
- Your code committed and pushed with a clean commit history
- Planning document completed in `planning/PLANNING.md`
- Updated README with your live URL at the top, architecture overview, and reflections
- Live deployment URL - **mandatory**. Must be functional at the deadline
- Walkthrough video (5 minutes) - record a short demo walking through your live dashboard and key technical decisions. Link it in your README.
...
- Use any AI coding tools. Document your usage in the README.
- Free data sources only. All suggested sources have free tiers.
- Keep AI API spend under $10 if using a paid provider. API costs are your own responsibility - stick to free tiers where possible (all suggested sources have them).
- No proprietary data. Everything must come from public sources.
- **Deadline is firm.** A well-built Tier 1 beats a rushed attempt at everything.
